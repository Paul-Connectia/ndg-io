...
const ArticlesPage = () => {
  const [activeType, setActiveType] = useState<ContentType | 'all'>('article');
  const sampleItems = sampleItemsData as Item[];

  const filteredItems = sampleItems.filter(item => item.type === 'article');

  return (
    <Layout
      title="Research Articles - NextDoc Labs"
      description="Original research advancing NHS workforce, IMG pathways, and medical education. Peer-reviewed studies following EQUATOR standards."
      canonical="/articles"
    >
      {/* Hero Section */}
        ...
        <div className="container mx-auto px-4 max-w-7xl">
          <div className="max-w-4xl">
            ...
            <p className="text-xl lg:text-2xl opacity-90 leading-relaxed">
              Original research advancing NHS workforce, international medical graduate integration, and medical education. All articles follow EQUATOR reporting standards (CONSORT, STROBE, SQUIRE).
            </p>
          </div>
        </div>
      </section>
